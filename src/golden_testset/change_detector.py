...
class ChangeRecord:
    ...
    old_hash: DocumentHash | None = None
    new_hash: DocumentHash | None = None
...
class HashCache:
    ...
    def get(self, document_id: str) -> DocumentHash | None:
    ...
    def put(self, document_id: str, doc_hash: DocumentHash) -> None:
        ...
        # Add new entry
        self._cache[document_id] = (doc_hash, datetime.now(UTC))
        self._access_order.append(document_id)
...
class ContentHasher:
    ...
    @staticmethod
    def hash_content(
        content: str, algorithm: HashAlgorithm = HashAlgorithm.SHA256
    ) -> str:
    ...
    @staticmethod
    def hash_metadata(
        metadata: dict[str, Any], algorithm: HashAlgorithm = HashAlgorithm.SHA256
    ) -> str:
...
class ChangeDetector:
    ...
    async def compute_document_hash(
        ...
        checksum_parts = ContentHasher.hash_document_parts(
            content, metadata, self.hash_algorithm
        )
    ...
    async def detect_changes(
        ...
        return ChangeDetectionResult(
            ...
            performance_metrics={
                "per_document_avg_ms": processing_time_ms
                / max(len(current_documents), 1),
                "meets_performance_target": processing_time_ms
    ...
    def _analyze_document_changes(
        self, doc_id: str, baseline_hash: DocumentHash, current_hash: DocumentHash
    ) -> ChangeRecord | None:
    ...
    def _classify_content_change(
        self, baseline_hash: DocumentHash, current_hash: DocumentHash
    ) -> dict[str, Any]:
        ...
        if baseline_hash.file_size and current_hash.file_size:
            ...
            size_change_pct = (
                (size_diff / baseline_hash.file_size) * 100
                if baseline_hash.file_size > 0
                else 0
            )
    ...
    async def batch_detect_changes(
        ...
        return ChangeDetectionResult(
            ...
            performance_metrics={
                ...
                "avg_batch_time_ms": total_time / len(document_batches)
                if document_batches
                else 0,
    ...
    def get_performance_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "total_processing_time_ms": self.performance_metrics[
